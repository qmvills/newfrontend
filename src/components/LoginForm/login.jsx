...
const Login = () => {
    return(
        <div className="w-full h-screen flex items-start"> {/*whole page*/}
            ...
            <div className="w-1/2 h-full bg-white flex flex-col p-32 my-20"> 
                ...
                <div className="w-full flex flex-col my-4">
                    <button className="w-full text-white bg-black rounded-md p-4 text-center flex items-center justify-center hover:bg-green-700 font-bold">Log In</button>
            ...
            </div>{/* end of right side of the page*/}

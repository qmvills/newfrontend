...
function First() {
    ...
    return (
        ...
        <h1 className="mt-8 px-10 text-3xl font-bold mb-4">Receive Amount from First Year</h1>

        <p className='text-black mb-4'>Treasurer: Quitat, Vladimyr</p> {/*coming from database*/}

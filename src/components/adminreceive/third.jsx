...
function Third() {
    ...
    return (
        ...
        <h1 className="mt-8 px-10 text-3xl font-bold mb-4">Receive Amount from Third Year</h1>

        <p className='text-black mb-4'>Treasurer: Jaso, The Great</p> {/*coming from database*/}
